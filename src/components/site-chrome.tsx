...
export function TabBar({ active }: { active?: TabKey }) {
  const tabs: { key: TabKey; label: string; href: string; icon: React.ReactNode }[] = [
    { key: "explore", label: "Explore", href: "/", icon: <Compass size={24} aria-hidden="true" /> },
    { key: "map", label: "Map", href: "/map", icon: <MapIcon size={24} aria-hidden="true" /> },
    { key: "add", label: "Add", href: "/add", icon: <Plus size={24} aria-hidden="true" /> },
    { key: "saved", label: "Saved", href: "/saved", icon: <Heart size={24} aria-hidden="true" /> },
    { key: "community", label: "Community", href: "/leaderboard", icon: <Users size={24} aria-hidden="true" /> },
  ];
  return (
