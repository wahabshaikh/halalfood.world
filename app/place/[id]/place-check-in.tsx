...
import { RELATIONSHIPS, RELATIONSHIP_COPY } from "../../../src/lib/halal-taxonomy";
    ...
    <section className="check-in is-open" aria-labelledby="check-in-title">
      ...
      <details className="check-in-more">
        ...
        <fieldset className="check-in-field">
          ...
          />
          <p className="check-in-hint">
            <Camera size={14} aria-hidden="true" /> Photos can be added from the
        ...
        <fieldset className="check-in-field">
          ...
          <label className="check-in-check">
            ...
            />
            <span>
              <MapPin size={14} aria-hidden="true" /> Use my location to verify
